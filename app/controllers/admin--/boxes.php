...
class Boxes extends Admin_Controller
{
	...
	function index()
	{
		...
		$data['view_page']=$this->config->item('admin_folder').'/box/index';
	...
	function form($id = false)
	{
		...
		if ($this->form_validation->run() == false)
		{
			$data['error'] = validation_errors();
				$data['view_page']=$this->config->item('admin_folder').'/box/form';
				$this->load->view($this->_container, $data);
		...
		{	
			...
			redirect($this->config->item('admin_folder').'/boxes/index');
		}	
	}
