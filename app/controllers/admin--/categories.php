...
class Categories extends Admin_Controller {	
	...
	function index()
	{
        ...
        /*foreach( $data['categories'] as $cat){
            foreach($cat as $key => $values){
                print_r($values->name); exit();
            }

        }*/

	    $data['view_page']=$this->config->item('admin_folder').'/category/index';
	...
	function organize($id = false)
	{
		...
		$this->load->view($this->config->item('admin_folder').'/category/category', $data);
	}
	...
	function form($id = false)
	{
		...
		{
			$data['view_page']=$this->config->item('admin_folder').'/category/form';
			$this->load->view($this->_container, $data);
		}
		else
		{
