...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<?php  //$this->admin_url = site_url($this->config->item('admin_folder')).'/';?>
			
			<a class="brand" href="<?php echo $this->admin_url;?>">GoCart</a>
				...
				<ul class="nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo $this->admin_url;?>orders"><?php echo lang('common_orders') ?></a></li>
							<?php if($this->auth->check_access('Admin')) : ?>
							<li><a href="<?php echo $this->admin_url;?>customers"><?php echo lang('common_customers') ?></a></li>
							<li><a href="<?php echo $this->admin_url;?>customers/groups"><?php echo lang('common_groups') ?></a></li>
							<li><a href="<?php echo $this->admin_url;?>reports"><?php echo lang('common_reports') ?></a></li>
							<li><a href="<?php echo $this->admin_url;?>coupons"><?php echo lang('common_coupons') ?></a></li>
							<li><a href="<?php echo $this->admin_url;?>giftcards"><?php echo lang('common_giftcards') ?></a></li>
							<?php endif; ?>
						</ul>
					</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo $this->admin_url;?>categories"><?php echo lang('common_categories') ?></a></li>
							<li><a href="<?php echo $this->admin_url;?>products"><?php echo lang('common_products') ?></a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo $this->admin_url;?>pages"><?php echo lang('common_pages') ?></a></li>
						</ul>
					</li>
