...
class Banner extends Admin_Controller
{
	...
	function index()
	{
		...
		$data['view_page']='banner/admin/banner/index';
	...
	function delete($id)
	{
		...
		redirect(site_url('banner/admin/banner'));
	}
	...
	********************************************************************/
	...
	function form($id = false)
	{
		...
		if($id)
		{
			$data['banner']	= $this->Banner_model->get_banners($id);
		...
		if ($this->form_validation->run() == false)
		{
			...
			$data['view_page']='banner/admin/banner/form';
			$this->load->view($this->_container, $data);
		}
		else
		{	
