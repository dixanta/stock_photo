...
$id = $key->id;
$title = $key->title;
$enable_on = $key->enable_on;
$disable_on = $key->disable_on;
$link = $key->link;
$new_window = $key->new_window;
}
endif;
...
<?php echo form_open_multipart('banner/admin/banner/form/'.$id); ?>
	...
	<div class="form-actions">
		...
		<a href="<?php echo site_url('banner/admin/banner')?>" class="btn btn-danger">Cancel</a>
	</div>
</form>
