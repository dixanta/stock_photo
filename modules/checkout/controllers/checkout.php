...
class Checkout extends Front_Controller {
	...
	function step_1()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$data['view_page']='checkout/address_form';
		...
		else
		{
			...
			if($this->input->post('use_shipping')=='yes')
			{
				...
				redirect(site_url('checkout/step_2'));	
			} else {
				redirect(site_url('checkout/shipping_address'));
			}
	...
	protected function shipping_form($shipping_methods)
	{
		...
		if($this->form_validation->run() == false)
		{	
			$data['view_page'] ='checkout/shipping_form';
		...
		else
		{
			...
			redirect(site_url('checkout/step_3'));
		}
	}
	...
	*/
	...
	function step_3()
	{
		...
		*/
		...
		{
			redirect(site_url('checkout/step_1'));
		}
	...
	function step_4()
	{
		...
		/* Confirm the sale */
		$data['view_page']='checkout/confirm';
