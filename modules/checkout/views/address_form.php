...
<div class="page-header">
	<h2><?php echo lang('form_checkout');?>Form Checkout</h2>
</div>
...
{
	$.post('<?php echo site_url('location/admin/location/get_zone_menu');?>',{id:$('#country_id').val()}, function(data) {
		$('#zone_id').html(data);
	});
}
</script>
		...
		<div class="row">
			...
			<div class="span8 offset2">
				<div class="row">
					...
					<div class="span4">
						<?php if($this->Customer_model->is_logged_in(false, false)) : ?>
							<button class="btn btn-inverse pull-right" onclick="$('#address_manager').modal().modal('show');" type="button"><i class="icon-envelope icon-white"></i> Address<?php echo lang('choose_address');?></button>
						<?php endif; ?>
					</div>
				</div>
				...
				<div class="row">
					<div class="span8">
						...
						Country<?php echo form_dropdown('country_id',$countries, @$customer[$address_form_prefix.'_address']['country_id'], 'id="country_id" class="address span8"');?>
					</div>
				</div>
				...
				<div class="row">
					<div class="span8">
						...
						address1<?php echo form_input($address1);?>
					</div>
				</div>
				...
				<div class="row">
					<div class="span8">
						...
						address2<?php echo form_input($address2);?>
					</div>
				</div>
				...
				<div class="row">
					<div class="span3">
						...
						<?php echo lang('ship_to_address') ?>Ship to address
						</label>
					</div>
				</div>
				<?php endif ?>
				...
				<div class="row">
					<div class="span8">
						...
						<?php endif; ?>
						<input class="btn btn-block btn-large btn-primary" type="submit" value="<?php echo lang('form_continue');?>continue"/>
					</div>
				</div>
			</div>
		</div>
