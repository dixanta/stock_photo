...
<div class="row">
	<div class="span4">
		<h3><?php echo lang('account_information');?>account_information</h3>
		<?php echo (!empty($customer['company']))?$customer['company'].'company<br/>':'';?>
		<?php echo $customer['firstname'];?>firstname <?php echo $customer['lastname'];?>lastname<br/>
		<?php echo $customer['email'];?> email<br/>
		<?php echo $customer['phone'];?>phone
	</div>
	<?php
	...
	<div class="span4">
		...
		<?php echo $ship['email'];?>email<br/>
		<?php echo $ship['phone'];?>phone
	</div>
	<?php if($ship != $bill):?>
	<div class="span4">
		<h3><?php echo lang('billing_information');?>billing_information</h3>
		<?php echo format_address($bill, TRUE);?><br/>
		<?php echo $bill['email'];?>email<br/>
		<?php echo $bill['phone'];?>phone
	</div>
	<?php endif;?>
</div>
...
<div class="row">
	<div class="span4">
		<h3><?php echo lang('additional_details');?>additional_details</h3>
		<?php
