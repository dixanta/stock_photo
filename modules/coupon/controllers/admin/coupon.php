...
class Coupon extends Admin_Controller {	
	...
	function index()
	{
		...
		$data['view_page']='coupon/admin/coupon/index';
	...
	function form($id = false)
	{
		...
		{	
			...
			if (!$coupon)
			{
				...
				redirect(site_url('coupon/admin/coupon/product'));
			}
		...
		{
			$data['view_page']='coupon/admin/coupon/form';
			$this->load->view($this->_container, $data);
		}
		else
		{
			...
			redirect(site_url('coupon/admin/coupon'));
		}
	}
