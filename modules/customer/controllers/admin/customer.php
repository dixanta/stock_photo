...
class Customer extends Admin_Controller {
	...
	function index($field='lastname', $by='ASC', $page=0)
	{
        ...
        $data['view_page']='customer/admin/customer/index';
	...
	function export_xml()
	{
		...
		force_download_content('customers.xml',	$this->load->view('customer/admin/customer/xml', $data, true));
	}
	...
	function form($id = false)
	{
		...
		{	
			...
			if (!$customer)
			{
                ...
                redirect(site_url('/customer/admin/customer'));
		...
		{
            $data['view_page']='customer/admin/customer/form';
	...
	function addresses($id = false)
	{
		...
		$data['view_page']='customer/admin/customer/addresses';
        $this->load->view($this->_container, $data);
	...
	function order_list($status = false)
	{
	 ...
	 $data['view_page']='customer/admin/customer/order_list';
        $this->load->view($this->_container, $data);
	}
	...
	function get_subscriber_list()
	{
		...
		$data['view_page']='customer/admin/customer/subscriber_list';
        $this->load->view($this->_container, $data);
	}	
	...
	function groups()
	{
        ...
        $data['view_page']='customer/admin/customer/group';
        $this->load->view($this->_container, $data);
		}
	...
	function edit_group($id=0)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
            $data['view_page']='customer/admin/customer/group_form';
            $this->load->view($this->_container, $data);
		}
		else
		{
			...
			redirect(site_url('/customer/admin/customer/groups'));
		}
	}
	...
	function address_list($customer_id)
	{
        ...
        $data['view_page']='customer/admin/customer/address_list';
        $this->load->view($this->_container, $data);
        }
	...
	function address_form($customer_id, $id = false)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
            $data['view_page']='customer/admin/customer/address_form';
            $this->load->view($this->_container, $data);
            }
		else
		{
			...
			redirect(site_url('/customer/admin/customer/addresses/'.$customer_id));
		}
	}
