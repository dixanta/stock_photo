...
?>
<?php echo form_open('customer/admin/customer/address_form/'.$customer_id.'/'.$id);?>
	...
	<div class="form-actions">
        ...
        <a href="<?php echo site_url('customer/admin/customer')?>" class="btn btn-danger">Cancel</a>
	</div>
	<script type="text/javascript">
	$(document).ready(function(){
		$('#f_country_id').change(function(){
			$.post('<?php echo site_url('customer/admin/customer/locations/get_zone_menu');?>',{id:$('#f_country_id').val()}, function(data) {
