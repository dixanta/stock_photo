...
Class Digital_Product extends Admin_Controller {
	...
	function index()
	{
		...
		$data['view_page'] = 'digital_product/admin/digital_product/index';
	...
	function form($id=0)
	{
		...
		{
			$data['view_page']='digital_product/admin/digital_product/form';
			$this->load->view($this->_container, $data);
			} else {
			...
			if($id==0)
			{
				...
				if($this->upload->do_upload())
				{
					...
					$data['view_page']='digital_product/admin/digital_product_form/index';
					$this->load->view($this->_container, $data);
					return;
				}
			...
			redirect(site_url('digital_product/admin/digital_product'));
		}
	}
