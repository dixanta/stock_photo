...
Class Digital_Product_Model extends MY_Model {
	...
	function get_list()
	{
		$this->db->from($this->_TABLES['DIGITAL_PRODUCTS']. ' digital_products');
	...
	function get_associations_by_file($id)
	{
		...
		$this->db->from($this->_TABLES['PRODUCTS_FILES']. ' products_files');
	...
	function get_user_downloads($customer_id)
	{
		...
		$this->db->from($this->_TABLES['DOWNLOAD_PACKAGES']. ' download_packages');
