...
echo form_open_multipart('digital_product/admin/digital_product/form/'.$id); ?>
	...
	<div class="form-actions">
		...
		<a href="<?php echo site_url('digital_product/admin/digital_product')?>" class="btn btn-danger">Cancel</a>
	</div>
