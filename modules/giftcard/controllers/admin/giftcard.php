...
class Giftcard extends Admin_Controller {
	...
	function index()
	{
		...
		$data['view_page']='giftcard/admin/giftcard/index';
	...
	function form()
	{
		...
		{
			$data['view_page']='giftcard/admin/giftcard/form';
			$this->load->view($this->_container, $data);
		}
		else
		{
			...
			redirect(site_url('giftcard/admin/giftcard'));
		}
	...
	{		
		...
		if ($this->form_validation->run() == FALSE)
		{
			$data['view_page']='giftcard/admin/giftcard/settings';
			$this->load->view($this->_container, $data);
		}
		else
		{
