...
<?php echo form_open('location/admin/location/zone_form/'.$id); ?>
	...
	?>
	<?php echo form_dropdown('country_id', $country_ids, set_value('country_id', $country_ids) ,'class="span12"');?>

	<label for="name"><?php echo lang('name');?></label>
	<?php $name = null; $status = null;
