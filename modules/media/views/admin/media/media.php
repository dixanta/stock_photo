	...
	<div class="navbar-inner">
		<div class="container-fluid">
			<ul class="nav">
				...
				if(!empty($root))
				{
					echo '<li><a href="'.site_url('media/admin/media').'"><i class="icon-home icon-white"></i> '.lang('goedit_root').'</a></li>';
					$back_link	= explode('/', $root);
					array_pop($back_link);
					$path	= '';
					foreach($back_link as $bl): $path.= $bl.'/';?>
					<li><a>/</a></li>
					<li title="<?php echo $path;?>"><a href="<?php echo site_url('media/admin/media/index/'.$path);?>"><?php echo $bl;?></a></li>
					<?php endforeach;
				}
				?>
			</ul>
			<?php echo form_open('media/admin/media/create_subfolder/', 'class="navbar-form pull-right"');?>
			...
			<?php echo form_open_multipart(site_url('media/admin/media/upload'), 'id="upload-form" class="form-inline navbar-form pull-right" style="margin-right:5px;"');?>
				<input type="hidden" name="root" value="<?php echo $root;?>">
	...
	foreach($files as $f):?>
		...
		if(is_dir($this->path.'/'.$root.'/'.$f)):?>
				<td class="file-icon" title="<?php echo $uri_root.$f;?>">
					<a href="<?php echo site_url('media/admin/media/index/'.$uri_root.$f);?>"><img src="<?php echo base_url('/assets/img/folder.png');?>" alt="<?php echo htmlentities($f);?>"></a>
				</td>
				<td><a href="<?php echo site_url('media/admin/media/index/'.$uri_root.$f);?>"><?php echo $f;?></a></td>
				<td class="btns">
...
<div class="modal" id="folder-name" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display:none;">
	...
	<div class="modal-body">
		...
		<?php echo form_open('media/admin/media/rename_file/', 'class="form-inline"');?>
			<div class="container-fluid">
				<div class="row-fluid">
					<input type="hidden" name="root" value="<?php echo $root;?>" >
		...
		<?php echo form_open('media/admin/media/delete/');?>
			<div class="container-fluid">
				<div class="row-fluid">
