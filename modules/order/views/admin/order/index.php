...
<div class="row">
	<div class="span12">
		<div class="btn-group pull-right">
			...
			<a class="btn" href="<?php echo site_url('order/admin/order/packing_slip/'.$order->id);?>" target="_blank"><i class="icon-file"></i><?php echo lang('packing_slip');?></a>
		</div>
	</div>
</div>
...
<div id="notification_form" class="row" style="display:none;">
	<div class="span12">
		<?php echo form_open('order/admin/order/send_notification/'.$order->id);?>
			<fieldset>
				...
				<div class="form-actions">
					...
					<a href="<?php echo site_url('order/admin/order')?>" class="btn btn-danger">Cancel</a>
				</div>
			</fieldset>
		</form>
	</div>
...
<?php echo form_open('order/admin/order/views/'.$order->id, 'class="form-inline"');?>
<fieldset>
	<div class="row" style="margin-top:20px;">
		<div class="span8">
