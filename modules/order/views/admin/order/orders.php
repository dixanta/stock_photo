<?php 
	...
	function sort_url($lang, $by, $sort, $sorder, $code, $admin_folder)
	{
		...
		$return = site_url('order/admin/order/index/'.$by.'/'.$sort.'/'.$code);
...
<div class="row">
	<div class="span12" style="border-bottom:1px solid #f5f5f5;">
		<div class="row">
			...
			<div class="span8">
				<?php echo form_open('order/admin/order/index', 'class="form-inline" style="float:right"');?>
					<fieldset>
...
<?php echo form_open('order/admin/order/bulk_delete', array('id'=>'delete_form', 'onsubmit'=>'return submit_form();', 'class="form-inline"')); ?>
...
<table class="table table-striped">
	...
	<tr>
		...
		<td>
			<a class="btn btn-small" style="float:right;"href="<?php echo site_url('order/admin/order/views/'.$order->id);?>"><i class="icon-search"></i> <?php echo lang('form_view')?></a>
		</td>
	</tr>
    <?php endforeach; ?>
    </tbody>
