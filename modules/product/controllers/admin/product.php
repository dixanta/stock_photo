...
class Product extends Admin_Controller {	
	...
	function index($order_by="name", $sort_order="ASC", $code=0, $page=0, $rows=15)
	{
		...
		$config['base_url']			= site_url('product/admin/product/index/'.$order_by.'/'.$sort_order.'/'.$code.'/');
		...
		$data['view_page']='product/admin/product/index';
	...
	function product_image_form()
	{
		...
		$data['error']	= false;
		$data['view_page']='product/admin/product/iframe/product_image_uploader';
		$this->load->view($this->_container, $data);
