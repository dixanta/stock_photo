...
<?php echo form_open('product/admin/product/form/'.$id ); ?>
<div class="row">
	<div class="span8">
		<div class="tabbable">
		...
		<div class="tab-content">
					...
					<div class="span2" style="text-align:center">
						<div class="row">
							<div class="span2">
								...
								{
									$.post("<?php echo site_url('category/admin/category/category_autocomplete/');?>", { name: $('#category_search').val(), limit:10},
										function(data) {
					...
					<div class="span2" style="text-align:center">
						<div class="row">
							<div class="span2">
								...
								{
									$.post("<?php echo site_url('product/admin/product/product_autocomplete/');?>", { name: $('#product_search').val(), limit:10},
										function(data) {
			...
			<div class="tab-pane" id="product_photos">
				<div class="row">
					<iframe id="iframe_uploader" src="<?php echo site_url('product/admin/product/product_image_form');?>" class="span8" style="height:75px; border:0px;"></iframe>
				</div>
				<div class="row">
					<div class="span8">
...
<div class="form-actions">
	...
	<a href="<?php echo site_url('product/admin/product/')?>" class="btn btn-danger">Cancel</a>
</div>
</form>
