...
function sort_url($lang, $by, $sort, $sorder, $code, $admin_folder)
{
	...
	$return = site_url('product/admin/product/index/'.$by.'/'.$sort.'/'.$code);
...
<div class="row">
	<div class="span12" style="border-bottom:1px solid #f5f5f5;">
		<div class="row">
			...
			<div class="span8">
				<?php echo form_open('product/admin/product/index', 'class="form-inline" style="float:right"');?>
					<fieldset>
						<?php
						...
						function list_categories($cats, $product_categories, $sub='') {
							...
							<!_-<option><?php print_r($value->name);?></option>-->
							<option class="span2" value="<?php echo $value->id;?>"><?php echo  $sub.$value->name; ?></option>
							<?php endforeach;?>
							<?php
						...
						<a class="btn" href="<?php echo site_url('product/admin/product/index');?>">Reset</a>
					</fieldset>
				</form>
			</div>
		</div>
...
<?php echo form_open('product/admin/product/bulk_save', array('id'=>'bulk_form'));?>
			...
			<tr>
				...
				<th>
					<span class="btn-group pull-right">
						...
						<a class="btn" style="font-weight:normal;"href="<?php echo site_url('product/admin/product/form');?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_product');?></a>
					</span>
				</th>
			</tr>
		</thead>
	...
	<?php foreach ($products as $product):?>
			<tr>
				...
				<td>
					<span class="btn-group pull-right">
						<a class="btn" href="<?php echo  site_url('product/admin/product/form/'.$product->id);?>"><i class="icon-pencil"></i>  <?php echo lang('edit');?></a>
						<a class="btn" href="<?php echo  site_url('product/admin/product/form/'.$product->id.'/1');?>"><i class="icon-share-alt"></i> <?php echo lang('copy');?></a>
						<a class="btn btn-danger" href="<?php echo  site_url('product/admin/product/delete/'.$product->id);?>" onclick="return areyousure();"><i class="icon-trash icon-white"></i> <?php echo lang('delete');?></a>
					</span>
				</td>
			</tr>
	<?php endforeach; ?>
