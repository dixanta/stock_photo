...
{
	show_animation();
	$.post('<?php echo site_url('report/admin/report/best_sellers');?>',{start:$('#best_sellers_start_alt').val(), end:$('#best_sellers_end_alt').val()}, function(data){
...
{
	show_animation();
	$.post('<?php echo site_url('report/admin/report/sales');?>',{year:$('#sales_year').val()}, function(data){
