...
class Secure extends Front_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('location/location_model','banner/banner_model','customer/Customer_model'));
	...
	function forgot_password()
	{
		...
		$data['view_page']='forgot_password';
	...
	function delete_address()
	{
		...
		$customer = $this->go_cart->customer();
		$id = $this->Customer_model->delete_address($id, $customer['id']);
		echo $id;
