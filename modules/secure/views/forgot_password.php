				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="submit" value="<?php echo lang('reset_password');?>Reset Password" name="submit" class="btn btn-primary"/>
						</div>
					</div>
				</fieldset>
		</form>
		<div style="text-align:center;">
			<a href="<?php echo site_url('secure/login'); ?>"><?php echo lang('return_to_login');?>Return to Login</a>
		</div>
	</div>
</div>
